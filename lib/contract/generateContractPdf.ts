...
export async function generateContractPdfBuffer(args: {
  ...
  doc.fontSize(9).fillColor("#94a3b8").text(
    "This document was generated by an automated system and carries the same legal weight as a manually prepared agreement when properly executed by both parties.",
    { align: "center" }
  );
